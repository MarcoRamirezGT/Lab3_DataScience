...
db[] <- lapply(db, function(x) as.numeric(as.character(x)))
#Convert factor the label column



str(db)
n <- neuralnet(label ~ pixel0+pixel1+pixel2+pixel3+pixel4+pixel5+pixel6+pixel7+pixel8,
               data = db,
              hidden = c(12,7),
